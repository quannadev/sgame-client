(function(e) {
let t = {
defineGetterSetter: function(e, t, s, r, i, n) {
...
if (!i && !n) for (var a = null != s, u = null != r, _ = Object.getOwnPropertyNames(e), h = 0; h < _.length; h++) {
var l = _[h];
...
for (var r in e) {
var i = e[r];
"object" !== ("undefined" == typeof i ? "undefined" : _typeof(i)) || !i || i instanceof t.Node || i instanceof HTMLElement ? s[r] = i : s[r] = t.clone(i);
}
return s;
},
inject: function(e, t) {
...
var i, n = this.prototype, o = Object.create(n), a = {
writable: !0,
enumerable: !1,
configurable: !0
};
...
this.__getters__ && (i.__getters__ = t.clone(this.__getters__));
this.__setters__ && (i.__setters__ = t.clone(this.__setters__));
for (var u = 0, _ = arguments.length; u < _; ++u) {
var h = arguments[u];
for (var l in h) {
var c = "function" == typeof h[l], R = "function" == typeof n[l], p = e.test(h[l]);
if (c && R && p) {
...
i.extend = t.Class.extend;
i.implement = function(e) {
...
let i = s[r], o = e.getKey(i), a = o.getObject();
t = n.encodeNObjectKey(t, i);
t = n.encodeObject(t, o.getTypeId(), a);
}
return t;
},
...
switch (t) {
case r.NULL:
return n.binEncode_NULL(e);

case r.BOOL:
return n.binEncode_BOOL(e, s);

case r.BYTE:
return n.binEncode_BYTE(e, s);

case r.SHORT:
return n.binEncode_SHORT(e, s);

case r.INT:
return n.binEncode_INT(e, s);

case r.LONG:
return n.binEncode_LONG(e, s);

case r.FLOAT:
return n.binEncode_FLOAT(e, s);

case r.DOUBLE:
return n.binEncode_DOUBLE(e, s);

case r.UTF_STRING:
return n.binEncode_UTF_STRING(e, s);

case r.TEXT:
return n.binEncode_TEXT(e, s);

case r.BOOL_ARRAY:
return n.binEncode_BOOL_ARRAY(e, s);

case r.BYTE_ARRAY:
return n.binEncode_BYTE_ARRAY(e, s);

case r.SHORT_ARRAY:
return n.binEncode_SHORT_ARRAY(e, s);

case r.INT_ARRAY:
return n.binEncode_INT_ARRAY(e, s);

case r.LONG_ARRAY:
return n.binEncode_LONG_ARRAY(e, s);

case r.FLOAT_ARRAY:
return n.binEncode_FLOAT_ARRAY(e, s);

case r.DOUBLE_ARRAY:
return n.binEncode_DOUBLE_ARRAY(e, s);

case r.UTF_STRING_ARRAY:
return n.binEncode_UTF_STRING_ARRAY(e, s);

case r.N_ARRAY:
let i = n.array2binary(s);
return n.addData(e, i);

case r.N_OBJECT:
{
let t = n.object2binary(s);
return n.addData(e, t);
}
...
if (!(i < 0)) {
for (let s = 0; s < i; s++) {
let s = e.readString(), r = n.decodeObject(e);
null != r && null != r && t.putNObject(s, r);
}
return t;
}
E.error("Cant decode NObject size is negative " + i);
},
...
if (!(i < 0)) {
for (let s = 0; s < i; s++) {
let s = n.decodeObject(e);
null != s && t.add(s);
}
return t;
}
console.error("Cant decode N_ARRAY size is negative " + i);
},
binDecode_NULL: function() {
return new i(r.NULL, null);
},
binDecode_BOOL: function(e) {
return new i(r.BOOL, e.readByte());
},
binDecode_BYTE: function(e) {
return new i(r.BYTE, e.readByte());
},
binDecode_SHORT: function(e) {
return new i(r.SHORT, e.readShort());
},
binDecode_INT: function(e) {
return new i(r.INT, e.readInt());
},
binDecode_LONG: function(e) {
return new i(r.LONG, e.readDouble());
},
binDecode_FLOAT: function(e) {
return new i(r.FLOAT, e.readFloat());
},
binDecode_DOUBLE: function(e) {
return new i(r.DOUBLE, e.readDouble());
},
binDecode_UTF_STRING: function(e) {
return new i(r.UTF_STRING, e.readString());
},
binDecode_TEXT: function(e) {
return new i(r.TEXT, e.readText());
},
getTypeArraySize: function(e) {
return e.readShort();
},
binDecode_BOOL_ARRAY: function(e) {
let t = n.getTypeArraySize(e), s = [];
for (let r = 0; r < t; r++) s.push(e.readByte());
return new i(r.BOOL_ARRAY, s);
},
...
return new i(r.BYTE_ARRAY, s);
},
binDecode_SHORT_ARRAY: function(e) {
let t = n.getTypeArraySize(e), s = [];
for (let r = 0; r < t; r++) s.push(e.readShort());
return new i(r.SHORT_ARRAY, s);
},
binDecode_INT_ARRAY: function(e) {
let t = n.getTypeArraySize(e), s = [];
for (let r = 0; r < t; r++) s.push(e.readInt());
return new i(r.INT_ARRAY, s);
},
binDecode_LONG_ARRAY: function(e) {
let t = n.getTypeArraySize(e), s = [];
for (let r = 0; r < t; r++) s.push(e.readLong());
return new i(r.LONG_ARRAY, s);
},
binDecode_FLOAT_ARRAY: function(e) {
let t = n.getTypeArraySize(e), s = [];
for (let r = 0; r < t; r++) s.push(e.readFloat());
return new i(r.FLOAT_ARRAY, s);
},
binDecode_DOUBLE_ARRAY: function(e) {
let t = n.getTypeArraySize(e), s = [];
for (let r = 0; r < t; r++) s.push(e.readDouble());
return new i(r.DOUBLE_ARRAY, s);
},
binDecode_UTF_STRING_ARRAY: function(e) {
let t = n.getTypeArraySize(e), s = [];
for (let r = 0; r < t; r++) s.push(e.readString());
return new i(r.UTF_STRING_ARRAY, s);
},
decodeObject: function(e) {
let t = null, s = e.readByte();
if (s == r.NULL) t = n.binDecode_NULL(e); else if (s == r.BOOL) t = n.binDecode_BOOL(e); else if (s == r.BOOL_ARRAY) t = n.binDecode_BOOL_ARRAY(e); else if (s == r.BYTE) t = n.binDecode_BYTE(e); else if (s == r.BYTE_ARRAY) t = n.binDecode_BYTE_ARRAY(e); else if (s == r.SHORT) t = n.binDecode_SHORT(e); else if (s == r.SHORT_ARRAY) t = n.binDecode_SHORT_ARRAY(e); else if (s == r.INT) t = n.binDecode_INT(e); else if (s == r.INT_ARRAY) t = n.binDecode_INT_ARRAY(e); else if (s == r.LONG) t = n.binDecode_LONG(e); else if (s == r.LONG_ARRAY) t = n.binDecode_LONG_ARRAY(e); else if (s == r.FLOAT) t = n.binDecode_FLOAT(e); else if (s == r.FLOAT_ARRAY) t = n.binDecode_FLOAT_ARRAY(e); else if (s == r.DOUBLE) t = n.binDecode_DOUBLE(e); else if (s == r.DOUBLE_ARRAY) t = n.binDecode_DOUBLE_ARRAY(e); else if (s == r.UTF_STRING) t = n.binDecode_UTF_STRING(e); else if (s == r.TEXT) t = n.binDecode_TEXT(e); else if (s == r.UTF_STRING_ARRAY) t = n.binDecode_UTF_STRING_ARRAY(e); else if (s == r.N_ARRAY) {
e.setCurrentPosition(e.position() - 1);
t = new i(r.N_ARRAY, n.decodeNArray(e));
...
let n = this.dataHolder.getItem(s), o = "";
if (n instanceof i) {
o = n.getDump();
n.getTypeId() == r.N_OBJECT && (t += "\t");
} else o = n;
e += t + "" + s + " : " + o;
}
return e;
...
t instanceof i ? this.dataHolder.setItem(e, t) : this.dataHolder.setItem(e, new i(s, t));
};
...
let t = new l();
t.initWithInt8Array(e);
return n.binary2array(t);
};
u.prototype.toBinary = function() {
return n.array2binary(this);
};
u.prototype.add = function(e) {
e instanceof i ? this._dataHolder.push(e) : e instanceof o && this.addNObject(e);
};
u.prototype.addObject = function(e, t) {
this._dataHolder.push(new i(t, e));
};
...
let i = new ArrayBuffer(r.length);
t = new Int8Array(i);
...
var i = u(new Uint8Array(e.slice(r, r + t)));
r += t;
return i;
};
...
for (var s = new l(), i = [], n = 0; n < t; n++) i.push(e[r + n]);
s.initWithInt8Array(i);
r += t;
return s;
};
...
for (var e = 0, t = n, s = 0; s < t.length; s++) {
...
for (var t = 0; t < e.length; t++) n.push({
t: "byt",
val: e[t]
});
};
...
function o(e) {
for (var t, s = "", r = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", i = new Uint8Array(e), n = i.byteLength, o = n % 3, a = n - o, u = 0; u < a; u += 3) s += r[(16515072 & (t = i[u] << 16 | i[u + 1] << 8 | i[u + 2])) >> 18] + r[(258048 & t) >> 12] + r[(4032 & t) >> 6] + r[63 & t];
1 == o ? s += r[(252 & (t = i[a])) >> 2] + r[(3 & t) << 4] + "==" : 2 == o && (s += r[(64512 & (t = i[a] << 8 | i[a + 1])) >> 10] + r[(1008 & t) >> 4] + r[(15 & t) << 2] + "=");
return s;
}
function a(e) {
...
var i = ((7 & r) << 18 | (63 & e[t + 1]) << 12 | (63 & e[t + 2]) << 6 | 63 & e[t + 3]) - 65536;
s += String.fromCharCode(i >> 10 | 55296, 1023 & i | 56320);
t += 3;
}
}
return s;
...
this._socket = new WebSocket(i, [], "cacert.pem"), this._socket.binaryType = "arraybuffer", 
...
a === Array || a === Object ? (i = null, u = a === Array ? "[Array]" : "[Object]", 
e(o, s, r + 1)) : i = o.constructor === Number ? "Num" : o.constructor === Boolean ? "Bool" : "SObject" === o.constructor.name ? "SObject" : o.constructor === String ? "Str" : "Unsupported";
}
let _ = " (" + i + ")";
"SObject" === i && (_ = i = o.getDump());
s.push(c.DebugHelper._getTabs(r) + n + ": " + (null == u ? o : u) + (null == i ? "" : _));
}
})(e, t, 0);
...
let t = o.newFromBinary(e), s = t.get(c.Controllers.ACTION_ID), r = t.get(c.Controllers.PARAM_ID), i = t.get(c.Controllers.CONTROLLER_ID), n = "<<<<<<<---------INCOMING DATA----------" + r.getDump();
n += i == R ? "IN System > : " + c.Requests.getRequestNameFromId(s) : "";
n += "\n<<<<<<<-----------END-------------------\n";
this.getLogger().debug(n);
null == s ? this._log.error("Message rejected: Action ID is Missing") : null == i ? this._log.error("Message Rejected : Controller ID is Missing") : this._controllers[i].handleMessage(s, r);
};
...
var r = null != this.config && null != this.config.host ? this.config.host : null, i = null != this.config && null != this.config.port ? this.config.port : null;
s = null != this.config && null != this.config.ssl ? this.config.ssl : null;
null != e && (r = e);
null != t && (i = t);
null == r || 0 == r.length ? this._log.error("Invalid connection host/address") : "number" != typeof i || 0 > i || 65535 < i ? this._log.error("Invalid TCP port") : this._socketEngine.connect(r, i, s);
}
};
...
if (null == r) {
let r = e.get(c.Requests.System.JoinRoomRequest.KEY_USER_LIST), i = e.get(c.Requests.System.JoinRoomRequest.KEY_ROOM), n = c.Entities.Room.fromArray(i);
n._setRoomManager(t);
n = t._replaceRoom(n, t.containsGroup(n.groupId));
for (let e = 0; e < r.size(); e++) {
let t = r.get(e).getObject(), s = this._getOrCreateUser(t, !0, n);
s._setPlayerId(t.get(3).getObject(), n);
n._addUser(s);
}
let o = i.get(8).value;
if (o >= 0) {
let e = n.getUserById(o);
n.setOwner(e);
}
n.isJoined = !0;
this._smartFox.lastJoinedRoom = n;
s.room = n;
...
if (null == s) {
let s = e.get(c.Requests.System.SpectatorToPlayerRequest.KEY_ROOM_ID), r = e.get(c.Requests.System.SpectatorToPlayerRequest.KEY_USER_ID), i = e.get(c.Requests.System.SpectatorToPlayerRequest.KEY_PLAYER_ID), n = this._smartFox.userManager.getUserById(r), o = this._smartFox.roomManager.getRoomById(s);
null != o ? null != n ? n.isJoinedInRoom(o) ? (n._setPlayerId(i, o), t.room = o, 
t.user = n, t.playerId = i, this._smartFox._dispatchEvent(c.Event.SPECTATOR_TO_PLAYER, t)) : this._log.warn("SpectatorToPlayer event, user " + n + " not joined in Room ", o) : this._log.warn("SpectatorToPlayer event, unknown User id: " + r) : this._log.warn("SpectatorToPlayer event, unknown Room id: " + s);
...
let t = {}, s = e.get(c.Controllers.KEY_ERROR_CODE);
if (null == s) {
let s = e.get(c.Requests.System.PlayerToSpectatorRequest.KEY_ROOM_ID), r = e.get(c.Requests.System.PlayerToSpectatorRequest.KEY_USER_ID), i = this._smartFox.userManager.getUserById(r), n = this._smartFox.roomManager.getRoomById(s);
t.playerId = i.getPlayerId(n);
null != n ? null != i ? i.isJoinedInRoom(n) ? (i._setPlayerId(-1, n), t.room = n, 
t.user = i, this._smartFox._dispatchEvent(c.Event.PLAYER_TO_SPECTATOR, t)) : this._log.warn("PlayerToSpectator event, user " + i + " not joined in Room ", n) : this._log.warn("PlayerToSpectator event, unknown User id: " + r) : this._log.warn("PlayerToSpectator event, unknown Room id: " + s);
} else this._smartFox._dispatchEvent(c.Event.PLAYER_TO_SPECTATOR_ERROR, {
ec: s,
...
for (t = 0; t < s.size(); t++) {
var i = c.Entities.Variables.UserVariable.fromArray(s.get(t).value);
e._setVariable(i);
r.push(i.name);
}
(s = {}).changedVars = r;
...
for (t = 0; t < s.size(); t++) {
var i = c.Entities.Variables.RoomVariable.fromArray(s.get(t).value);
e._setVariable(i);
r.push(i.name);
}
(s = {}).changedVars = r;
...
let i = t.get(e).value;
var r = c.Entities.User.fromArray(i);
s.push(r);
}
...
for (let e = 0; e < t.size(); e++) {
let r = t.get(e).value, i = c.Entities.Room.fromArray(r);
s.push(i);
}
...
c.Entities.Match.MatchExpression.chainedMatchExpression = function(e, t, s, r, i) {
...
let r = e[s], i = u.newInstance();
null == r[0] ? i.addNull() : i.addUtfString(r[0]);
i.addUtfString(r[1]);
i.addByte(r[2]);
i.addUtfString(r[3]);
let n = r[4];
"string" == typeof n && i.addUtfString(n);
"number" == typeof n && i.addDouble(n);
"boolean" == typeof n && i.addBool(n);
o === typeof n && i.addNObject(n);
t.addNArray(i);
}
return t;
};
...
var s, r = this.getRoomListFromGroup(t), i = !1, n = "number" == typeof e;
for (s in r) {
var o = r[s];
if (n) {
if (o.id == e) {
